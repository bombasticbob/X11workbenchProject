...
/*****************************************************************************
  ...
  of the source files or algorithms that are included with thi __WBLineBuffers one.
...
#include "text_object.h" // needed for  s_WB_EDIT_CONTROL
...
// specialized structures 'derived' from WBDialogC __WBLineBufferontrol (internal only)
/** \struct s_WB_IMAGE_CONTROL
...
/** \struct s_WB_PUSHBUTTON_CONTROL
  * \ingroup dlgctrl_structures
...
/** \typedef WBPushButtonControl
  ...
  * \code
  ...
  typedef struct s_WB_PUSHBUTTON_CONTROL
  {
    WBDialogControl wbDLGCtrl; // Standard dialog control members
    Pixmap pixmap;             // foreground pixmap
    Pixmap pixmap2;            // background (transparency) pixmap
